...
df_correlation_check_X = df[['meanX_F', 'stdX_F', 'shapeX_F',
                             'rmsX_F', 'ImpulseX_F', 'ppX_F', 'KurtX_F', 'CrestX_F', 'SkewX_F']]
...
plt.show()
# here we got that the main params are
independent_names = ['shapeX_F', 'shapeY_F', 'shapeZ_F',
                     'rmsX_F', 'rmsY_F', 'rmsZ_F',
                     'ppX_F', 'ppY_F', 'ppZ_F',
                     'KurtX_F', 'KurtY_F', 'KurtZ_F',
                     'CrestX_F', 'CrestY_F', 'CrestZ_F',
